# Installation
Qkmaxware.Parsing is distributed as a Nuget package via [Github's Package Repository](https://github.com/qkmaxware/CsRender/packages).
...
3. Add the `Qkmaxware.Parsing` package, make sure to specify Github as the package source

```
dotnet add package Qkmaxware.Parsing --source "https://nuget.pkg.github.com/qkmaxware/index.json"
```